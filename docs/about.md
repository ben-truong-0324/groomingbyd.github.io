...
<section class="cat-grooming-notice" style="text-align: center; padding: 30px 5%; max-width: 800px; margin: 0 auto;">
    <h3 style="color: var(--neon-pink); margin-bottom: 15px;">🐱 We Do Cats, Too!</h3>
    <p style="font-size: 1.1rem; line-height: 1.6; color: var(--black);">
        We also offer <strong>cat baths and grooming</strong> with an experienced cat groomer. Feel free to use the chat link in the bottom corner to chat directly with Vacaville Grooming Depot and ask any questions!
    </p>
</section>
